...
#ifndef DataAnalyst_PassRefPtr_h
#define DataAnalyst_PassRefPtr_h
#include "Platform.h"
...
using DrRobot::PassRefPtr;
using DrRobot::NonNullPassRefPtr;
using DrRobot::adoptRef;
using DrRobot::static_pointer_cast;
using DrRobot::const_pointer_cast;
#endif

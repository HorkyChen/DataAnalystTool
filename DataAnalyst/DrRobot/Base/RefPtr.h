...
//
#ifndef __DataAnalyst__RefPtr__
#define __DataAnalyst__RefPtr__
#include <algorithm>
#include <string>
...
namespace DrRobot {
    ...
    template<> inline bool operator==(const RefPtr<DataFlowElement>& a, const char* b)
    { 
        return a.get()->name()== b; 
    }
    
    template<typename T, typename U> inline bool operator==(const RefPtr<DataFlowElement>& a, const string& b)
    { 
        return a.get()->name() == b; 
    }
}

#endif /* defined(__DataAnalyst__RefPtr__) */

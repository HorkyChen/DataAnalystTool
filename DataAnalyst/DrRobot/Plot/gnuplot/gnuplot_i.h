 ...
 */
/*--------------------------------------------------------------------------*/
void gnuplot_plot_x(gnuplot_ctrl * handle, float * d, std::string* label, int n, const char * title);
void gnuplot_plot_x_int(gnuplot_ctrl * handle, int * d, std::string* label, int n, const char * title);
